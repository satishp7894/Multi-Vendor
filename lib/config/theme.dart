...
class AppColors {
  ...
  static const aboutUsBg = Color.fromRGBO(137, 137, 137, 0.6);
  ...
  static const orderDetailTitle = Color(0xFF5B5B5B);
  ...
  static const wishListImageBg = Color(0xFFF0EFED);
  ...
  static const colorInside = Color.fromRGBO(0, 0, 0, 0.1);
  static const colorOutside = Color.fromRGBO(0, 0, 0, 0.15);
  static const validationBg1 = Color.fromRGBO(137, 137, 137, 0.2);
  static const finestFestiveFashion = Color.fromRGBO(238, 75, 76, 0.3);
  static const fbBackground = Color.fromRGBO(29, 45, 61, 1);
