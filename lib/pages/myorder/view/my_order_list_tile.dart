...
class MyOrderTile extends StatelessWidget {
  ...
  MyOrderTile({this.categoriesList, this.onChanged});
      ...
      child: Column(
        children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            rowWidget("Order No : ", "1924444", Colors.grey, Colors.black,
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              rowWidget("Quantity :  ", "10", Colors.grey, Colors.black,
                  FontWeight.w400, FontWeight.bold),
              rowWidget("Total Amount :  ", "122", Colors.grey, Colors.black,
                  FontWeight.w400, FontWeight.bold)
            ],
          ),
          SizedBox(
          ...
          Row(
            ...
            children: [
              InkWell(
                onTap: () {
                  Get.toNamed(Routes.myOrderDetails);
                },
                child: Container(
