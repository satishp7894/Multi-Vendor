...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    //   profileController!.genderTexcontroller!.text = customer.gender!;
    //
    // }
    super.initState();
  }
            ...
            Obx(() {
              if(profileController!.isLoadingCustomerProfile.value != true){
                ...
                if (customerProfileData.isNotEmpty) {
                  ...
                  profileController!.emailTextController = TextEditingController();
                  profileController!.genderTexcontroller = TextEditingController();
                  profileController!.nameTexcontroller = TextEditingController();
                  profileController!.mobileTextController = TextEditingController();
                  profileController!.birthdateTexcontroller = TextEditingController();
                  profileController!.locationTextController = TextEditingController();
                  profileController!.numberTexcontroller = TextEditingController();
                  profileController!.hintTextController = TextEditingController();
                }
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        setState(() {
                          genderValue = "Male";
                          profileController!.genderTexcontroller!.text =
                              genderValue;
                        });
                      },
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border(
                            right:
                                BorderSide(width: 1, color: AppColors.appText1),
  ...
  void submit() async {
    CheckLogin? checkLogin =
        await profileController!.updateCustomerProfile();
