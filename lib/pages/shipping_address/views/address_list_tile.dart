                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          InkWell(
                              ...
                              child: Text("EDIT",style: GoogleFonts.inriaSans(textStyle: TextStyle(color: AppColors.appRed,fontWeight: FontWeight.w700,fontSize: 16))),
                            onTap: () async {
                              if(widget.isBool! == true){
                                print("Shipping Address Screen  ${widget.isBool!}");
                              }else{
                          ...
                          InkWell(
                            child: Text("REMOVE",style: GoogleFonts.inriaSans(textStyle: TextStyle(color: AppColors.appRed,fontWeight: FontWeight.w700,fontSize: 16)),
                            ),
                            onTap: (){
                              AlertDialogs.showAlertDialog("Delete?", "Are you "
                                  " you want to delete from this Address?", () async {
