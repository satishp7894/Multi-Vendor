  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: Style.Colors.appColor,size: 30,),
          onPressed: () =>
              Navigator.of(context, rootNavigator: true).pop(),
        ),
        title: Text(products!.productName.toString(),style: const TextStyle(fontSize: 20,color: Style.Colors.appColor)),
        // actions: [
        //   Center(
        //     child: Padding(
      ...
      RefreshIndicator(
        onRefresh: () {
          ...
          return productDetailsController!.productDetails(products!.productId!);;
        },
            child: Obx((){
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                'Rs.' + productDetailData[0].mrpPrice!,
                                                style: TextStyle(
                                                    fontSize: 20,
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            // Text(
                                            //   productDetailData[0].description.toString(),
                                            //   style: TextStyle(
                                            //       fontSize: 15,
                                            //       color: Colors.black.withOpacity(0.6)),
                                            // ),
